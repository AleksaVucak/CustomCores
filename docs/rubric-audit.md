...
| 11 | 2 | Website available online live | production URL (README slot) | README production-URL row; `docs/production-requirements.md`, `docs/deployment-troubleshooting.md`, `docs/installation-guide.md` | **Blocked on live host:** page slot + production requirements checklist + deploy/rollback docs ready; **live-load test pending hosting** — the only item without a passing live test | **Blocked** |
