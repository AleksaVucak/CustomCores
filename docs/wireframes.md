...
**Notes:** Private area; guests redirect to login.
...
**Notes:** Supports both catalogue products and custom builds.
...
**Acceptance:** For all six core screens, primary navigation is present in both desktop and mobile wireframes.
...
5. Convert these wireframes into CSS layout (`main.css`) and refine per theme.
6. Mobile navigation toggle is implemented (`assets/js/main.js`).

---

## 9. Status

**Summary.** Visual coding follows; these wireframes are the layout contract for the six priority screens.
