...
**Last updated:** Stage 14 / Commit 14.6 (HTML & CSS comments — structured section comments in views)
...
| 6 | All code properly commented (HTML, CSS, JS, and related sources) | 8 | Structured comments in HTML/PHP views, `assets/css/*`, `assets/js/*`, SQL seeds | Major sections documented; comments explain purpose, not obvious syntax | 14.6–14.7 | In progress — CSS fully commented (numbered section headers/dividers in `main.css` + `admin.css` + all three themes) and 14.6 adds purpose-first `<!-- section -->` comments to every storefront and admin view template (41 files, additions-only, all `php -l` clean); JS + PHP function/section comments remain (14.7) |
