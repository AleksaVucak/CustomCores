...
| 11 | Website available online live (preferably `myweb.cs.uwindsor.ca`) | 2 | Production URL recorded in README; production requirements + safe config templates + deployment docs in `docs/` / `config/` | Homepage loads publicly without PHP fatals; core flows work on host | 16.x | In progress — host requirements ([`production-requirements.md`](production-requirements.md)) and credential-free production config ([`production-configuration.md`](production-configuration.md), `database.example.php`, `app.production.example.php`, `verify-config.php`) ready; **live-load test still blocked until the public host is online** |
...
| B14 | Installation documentation for another server | `docs/production-requirements.md`, `docs/production-configuration.md`, `docs/installation-guide.md`, `docs/deployment-troubleshooting.md`, `config/*example*` | 12.4–12.5, 16.1–16.2, 16.x | In progress — host requirements ([`production-requirements.md`](production-requirements.md)), secret-free config templates ([`production-configuration.md`](production-configuration.md), `database.example.php`, `app.production.example.php`, `verify-config.php`), install and deploy guides published; final live confirmation still pending the hosted site |
