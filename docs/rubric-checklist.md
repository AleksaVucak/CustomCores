...
**Last updated:** Stage 15 / Commit 15.4 (desktop responsiveness testing)
...
| B15 | Desktop and mobile responsiveness (at least one desktop and one mobile) | Responsive CSS; test checklists in Stage 15 | 1.5, 15.4–15.5 | In progress — desktop verified (15.4, [`docs/responsiveness-desktop.md`](responsiveness-desktop.md): public + customer + admin at 1024/1280/1440/1920, 0 unintended overflow, container caps/centres, 0 defects); mobile pending (15.5) |
