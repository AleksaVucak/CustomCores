...
| B7 | Admin: edit data records (products/services/options) | `admin/products.php`, `product-add.php`, `product-edit.php`, `product-options.php` | 9.2–9.3 | Done — products CRUD (9.2: add/edit/price/stock/image/disable + secure uploads) and product options CRUD (9.3: grouped add/edit/reorder/price-delta/enable-disable/set-default/delete with one-default-per-group invariant) |
