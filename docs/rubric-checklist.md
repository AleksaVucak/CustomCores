...
| B7 | Admin: edit data records (products/services/options) | `admin/products.php`, `product-add.php`, `product-edit.php`, `product-options.php` | 9.2–9.3 | Products CRUD done (9.2: add/edit/price/stock/image/disable + secure uploads); options page in 9.3 |
